					...
					<div class="row">
						<div class="col-md-4"> 
							<div class="content-box">
								...
								<h3 class="content-title special-text-format">
								    <span class='special-text-format'>		
									<?php echo esc_html($heal_option['heal_causes_title']); ?>                     </span>  
								</h3>
 
								<?php echo wp_kses_stripslashes($heal_option['heal_causes_des']); ?>

								<div id="causes-owl-nav" class="slide-nav-container owl-nav flechacausa"></div><!-- /.slide-nav-container -->
