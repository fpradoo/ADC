...
function ccr_option_element( $name, $attr_option, $type, $shortcode ){
            ...
            <div class="content"><select id="'.$name.'">';
                ...
                <div class="icon-option">';
                    ...
                    if( $name == 'progressbar' ){
                        ...
                        <a href="#" class="btn yellow remove-list-item">'.__('Remove', 'heal' ). '</a> 
                        <a href="#" class="btn yellow add-list-item">'.__('Add', 'heal' ).'</a>';
                    ...
                    elseif( $name == 'image' ){
                        ...
                        <div class="shortcode-dynamic-item" id="options-item" data-name="image-upload">
                            ...
                            <div class="content">
                                ...
                                <a data-update="Select File" data-choose="Choose a File" href="javascript:void(0);"class="redux-opts-upload button-secondary" rel-id="">' . __('Upload', 'heal') . '</a>
                                <a href="javascript:void(0);" class="redux-opts-upload-remove" style="display: none;">' . __('Remove Upload', 'heal') . '</a>';
