...
<div id="shortcode-generator">
    ...
    <div class="shortcode-content">     
        ...
        <div class="content"><select id="ccr-shortcodes" data-placeholder="' . __("Choose a shortcode", 'heal') .'">
        <option value=""> - Select a shortcode - </option>';
        
        foreach( $ccr_shortcodes as $shortcode => $options ){
            ...
            if(strpos($shortcode,'header') !== false) {
                ...
                if( !empty($options['attr']) ){
                     foreach( $options['attr'] as $name => $attr_option ){
                        $html_options .= ccr_option_element( $name, $attr_option, $options['type'], $shortcode );
                     }
                }
...
<!--style-->
<link rel="stylesheet" href="<?php echo CC_CSS;?>font-awesome.min.css" />
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/inc/shortcodes/css/style.css" />

<!--scripts-->
<script src="<?php echo get_template_directory_uri(); ?>/inc/shortcodes/js/popup.js"></script>
...
<?php echo $shortcode_html . $html_options;  ?>
    ...
    <div id="shortcode-content">
        ...
        <div class="label"><label id="option-label" for="shortcode-content"><strong><?php echo __( 'Content: ', 'heal' ); ?></strong> </label></div>
    ...
    <a class="btn" id="add-shortcode"><?php echo __( 'Add Shortcode', 'heal' ); ?></a>
